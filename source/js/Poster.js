...
(function($) {
    ...
    posterMovieGrid.prototype = {
        reset: function(o) {
            ...
            this.rotatetype = option.rotatetype
                ? option.rotatetype
                : 'product';
            ...
            this.timer = null;
            this.locked = false;
            this.imgplace = '//static.youku.com/index/img/spacer.gif';
            this.paused = false;
            this.pos_start = 0;
            this.gestures = false; //双手指协同
            this.hotcode = option.hotcode
                ? option.hotcode
                : false;
            /*
            if(parseInt($('body').outerWidth())>1255 || navigator.userAgent.indexOf('iPad') !== -1){
                    this.width = 1190;
            }else{
                    this.width = 970;
            }
        ...
        turnpage: function(pagenum, type) {
            ...
            var c = direction == 'left'
                ? -this.rect
                : this.rect;
            var b = direction == 'left'
                ? 0
                : 0;
